		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Appointment View Application",
									"targetURL": "#appointmentviewapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appointmentviewapp-display": {
								"semanticObject": "appointmentviewapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appointmentviewapp",
									"url": sap.ui.require.toUrl("appointmentviewapp")
								}
							}
						}
					}
